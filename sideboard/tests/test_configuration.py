...
from sideboard.tests import SideboardTest
from sideboard.config import parse_config


class SideboardConfigurationTest(SideboardTest):
    ...
    def test_parse_config_adding_root_and_module_root_for_dev(self):
        ...
        self.assertEqual(test_config.get('module_root'), expected_module_root)
        self.assertEqual(test_config.get('root'), expected_root)
